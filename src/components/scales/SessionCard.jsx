...
export default function SessionCard({ session, onStart }) {
  return (
    <Card className="py-1.5 px-2 bg-white border border-gray-200 rounded-lg">
      <div className="flex items-center justify-between">
        ...
        <Button 
          ...
          className="bg-blue-600 hover:bg-blue-700 text-white rounded-full px-2 py-0.5 text-xs h-5 ml-1.5 flex-shrink-0"
        >
          Start
        </Button>
      </div>
